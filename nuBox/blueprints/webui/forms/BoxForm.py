...
class BoxCreate(Form):
  ...
  goal = IntegerField('Meta', validators=[DataRequired()], render_kw={"placeholder": "Pense em uma meta..."})
  value = IntegerField('Saldo', render_kw={"disabled": "true"})
  description = TextAreaField('Descrição', render_kw={"placeholder": "Eu criei essa caixinha por que..."})